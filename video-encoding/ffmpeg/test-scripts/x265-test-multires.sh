...
common_options="-c:v libx265 -x265-params info=0:weightb=1:ssim=1:psnr=1:ssim-rd=1:dynamic-rd=4:open-gop=0 -profile:v main -c:a aac -sws_flags bicubic -hls_list_size 1 -strict -2 -f mp4 -tag:v hvc1"
