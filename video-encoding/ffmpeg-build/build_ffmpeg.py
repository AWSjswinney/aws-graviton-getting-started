...
DEFAULT_VERSIONS = {
    ...
    "x265": "4.1",
    "aom": "v3.10.0",
    "SVT-AV1": "v2.3.0",  # v3.x changes API (2-arg init), v4.x renames aq field
    "opus": "v1.5.2",
}
...
def run(cmd, cwd=None, check=True, capture=False):
    ...
    r = subprocess.run(cmd, cwd=cwd, check=check, capture_output=capture, text=capture)
    return r
...
RUN ffmpeg -encoders 2>/dev/null | grep -E '(libx264|libx265|libaom|libsvtav1)'
"""
