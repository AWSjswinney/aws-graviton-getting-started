...
- AL2023: gcc (11), gcc14, clang (15), clang18, clang19
- Ubuntu Jammy: gcc (11), gcc9-12, clang (14), clang11-14
- Ubuntu Noble/Resolute: gcc (13), gcc9-14, clang (18), clang14-20
...
| AV1 | SVT-AV1 | Standalone binary (not linked into ffmpeg) |
| Opus | libopus | Audio |

Note: SVT-AV1 is built as a standalone encoder (`SvtAv1EncApp`) rather than linked into ffmpeg due to API incompatibilities between recent SVT-AV1 and ffmpeg releases.
...
Run `./test_matrix.py > results.md` to generate updated results.
